                ...
                <div className="create-channel-modal__form">
                    ...
                    {users.length > 0 && users.map(user => {
                        ...
                        return (
                            <label
                                key={user.id}
                                className={`mt-2 flex items-center gap-4 p-3 rounded-lg cursor-pointer transition-all shadow-sm bg-white hover:bg-[#f5f3ff] border-2 ${isChecked ? "border-[#611f69] bg-[#f3e6fa]" : "border-gray-200"
                                    }`}
                            >
                                <input type="checkbox"
