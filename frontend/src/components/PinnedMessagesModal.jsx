    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg mx-4">
        ...
        <div className="flex items-center justify-between border-b px-6 py-4">
          ...
          <button onClick={onClose} className="text-2xl text-gray-500 hover:text-gray-700 cursor-pointer">
        ...
        <div className="px-6 py-4 max-h-96 overflow-y-auto">
          {pinnedMessages.map((msg) => (
            <div key={msg.id} className="flex gap-3 py-4 border-b last:border-b-0 items-center">
              <img
                src={msg.user.image}
                alt={msg.user.name}
              ...
              <div className=" text-sm font-medium text-gray-700">{msg.user.name}</div>
